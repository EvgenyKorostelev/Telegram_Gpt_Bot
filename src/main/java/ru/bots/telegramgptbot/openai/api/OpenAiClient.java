...
public class OpenAiClient {
    ...
    public ChatCompletionResponse createChatCompletion(ChatCompletionRequest request) {
        ...
        ResponseEntity<ChatCompletionResponse> responseEntity = restTemplate.exchange(url, HttpMethod.POST,
                httpEntity, ChatCompletionResponse.class);
    ...
    public TranscriptionResponse createTranslation(CreateTranslationRequest request) {
        ...
        HttpHeaders httpHeaders = new HttpHeaders();
        httpHeaders.set("Authorization", "Bearer " + token);
        httpHeaders.set("Content-type", "multipart/from-data");
        ...
        ResponseEntity<TranscriptionResponse> responseEntity = restTemplate.exchange(url, HttpMethod.POST,
                httpEntity, TranscriptionResponse.class);
        return responseEntity.getBody();
    }
}
